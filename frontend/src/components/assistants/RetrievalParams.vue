<template>
  <div class="retrieval-params text-main">
    ...
    <!-- Basic Section -->
    <div v-if="section === 'all' || section === 'basic'" class="row justify-center">
      <div class="col-10">
        <div class="q-pt-sm">
          <q-input
    ...
    <div v-if="section === 'all' || section === 'rerank'" class="row justify-center">
      <div class="col-10">
        <q-toggle
        ...
        >
          ...
          <div class="q-mt-lg q-gutter-y-md">
            ...
            <div class="q-pa-sm bg-secondary" style="border: 1px solid var(--q-sixth)">
              <div class="q-mb-xs">
                {{ t('similarityCutoff') }} ({{ config.similarity_cutoff }})
              </div>
              <q-slider
